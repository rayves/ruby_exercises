...
This problem is tough, but fun. Come back to this challenge if you are spending too much time on it.
...
Write a method called the_hats_problem which contains your logic and returns the result. The result should be an array of strings containing 0's (hats off) and 1's (hats on).
 
=end

def the_hats_problem
end